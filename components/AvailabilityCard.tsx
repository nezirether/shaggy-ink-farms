...
export function AvailabilityCard() {
  return (
    <section className="px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-8 rounded-sm border-2 border-[#1C1C1A] bg-[#F5F0E8] p-6 shadow-[12px_12px_0_rgba(44,74,46,0.18)] md:grid-cols-[1fr_0.8fr] md:p-10">
        <div>
        ...
        <div className="rounded-sm bg-[#2C4A2E] p-5 text-[#F5F0E8]">
