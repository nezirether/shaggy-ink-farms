...
export function GardenPlannerApp() {
  const { state, setTab, planSummary, resetPlanner } = useGardenPlanner();
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-[#1C1C1A]/65">
                Calculate how many plants to grow, how much room they need, and whether to plant them all at once or in stages.
              </p>
