...
**Three jobs, in order:**
1. **Declare identity in 5 seconds** — heritage poultry on a Northern California family homestead, built in public.
2. **Route the two audiences** — Door A (poultry people: heritage + local eggs) and Door B (NorCal gardeners from search). Masterplan §1.
3. **Capture the email** — the spine that connects every future revenue room.
...
```
1  HERO ........................ declare identity + capture email + route to Poultry
2  TWO DOORS .................... route Poultry vs Learn & Plan (50/50)
3  POULTRY STRIP ................ promote the strongest section (3 ranked CTAs)
4  LEARN & PLAN STRIP ........... promote the planner + local-guide SEO hook
5  WATCH STRIP (compact) ........ latest video → YouTube subscribe
6  FROM THE JOURNAL ............. 3 latest dated cards (freshness/trust/SEO)
7  MEET THE FAMILY (compact) .... humanize; the "real family" proof
8  ON THE HORIZON ............... strawberries · flowers · store notify-me
9  GET FARM UPDATES (band) ...... closing email capture (spine)
10 FOOTER ....................... five-pillar IA mirror
```

**Why this order:** identity → routing → the money section (Poultry) → the traffic section (Learn & Plan) → audience (Watch) → trust/freshness (Journal) → humanity (Family) → future demand (Horizon) → spine capture. The current homepage's "What We're Working On" and Giant Pumpkin are gone (see §17).
...
│  eyebrow: Anderson, California · a family homestead                        │
│  H1: Heritage Plymouth Barred Rocks, raised on oak pasture.               │
│  Sub: A family farm in Anderson, CA — building a documented Barred Rock    │
│       breeding program, with pasture eggs and a food garden along the way.│
│  ┌ inline EmailCapture (one field) ─────────────┐   PRIMARY               │
│  │ [ your@email ]  [ Get Farm Updates ]         │                          │
│  └───────────────────────────────────────────────┘                         │
...
├──────────────────────────────────────────────────────────────────────────┤
│ POULTRY  (largest content block)                       JOB: promote #1     │
...
│  [ Notify me ] on each (tagged strawberries / flowers / store)            │
├──────────────────────────────────────────────────────────────────────────┤
│ GET FARM UPDATES  (band)  EmailCapture general-farm-updates  JOB: spine     │
├──────────────────────────────────────────────────────────────────────────┤
...
|---|---|---|---|---|
| 1 | Primary | **Get Farm Updates** | inline `EmailCapture` → `general-farm-updates` | nav, hero, closing band |
...
- Eyebrow: `Anderson, California · a family homestead`
- H1: **Heritage Plymouth Barred Rocks, raised on oak pasture.**
- Subhead: *A family farm in Anderson, CA — building a documented Barred Rock breeding program, with pasture eggs and a food garden along the way. Built slowly, recorded openly.*
- Email microcopy: *Get farm updates — the flock, the breeding work, and the build. About once or twice a month.*
...
**On the horizon**
- *Not ready yet, but coming: strawberries, cut flowers, and a small farm store. Tell us what to notify you about.*

**Closing band**
- Heading: **Follow the build of Shaggy Ink Farms.** Button: `Get Farm Updates`.
...
- **The "What We're Working On" featureCards block** as currently positioned — its content is absorbed by the two-doors router and the Poultry/Learn strips.
...
- **Inline hero email capture** (single field, `general-farm-updates`).
...
- [ ] Hero leads with heritage poultry (one `H1`), includes an **inline `EmailCapture`** (`general-farm-updates`) and an "Explore Poultry" secondary button.
